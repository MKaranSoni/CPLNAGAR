...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F5FC] text-slate-700 relative overflow-hidden">
      ...
      {/* Landing Header */}
      <header className="max-w-6xl mx-auto px-6 py-2 flex justify-between items-center relative z-10">
      ...
      {/* Hero Section */}
      <section className="max-w-5xl mx-auto px-6 pt-2 pb-6 relative z-10 text-center">
        <motion.div
